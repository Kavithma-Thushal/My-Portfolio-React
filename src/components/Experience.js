              ...
              <div className="grid md:grid-cols-2">
                <div className="md:text-end md:me-8 relative">
                  <img
                    ...
                    alt=""
                  />
                  <h5 className="my-2 font-semibold text-lg">Exbito</h5>
              ...
              <div className="grid md:grid-cols-2">
                <div className="text-start md:ms-8 relative md:order-2">
                  <img
                    ...
                    alt=""
                  />
                  <h5 className="my-2 font-semibold text-lg">ElitLand</h5>
              ...
              <div className="grid md:grid-cols-2">
                <div className="md:text-end md:me-8 relative">
                  <img
                    ...
                    alt=""
                  />
                  <h5 className="my-2 font-semibold text-lg">BeepTunes</h5>
              ...
              <div className="grid md:grid-cols-2">
                <div className="text-start md:ms-8 relative md:order-2">
                  <img
                    ...
                    alt=""
                  />
                  <h5 className="my-2 font-semibold text-lg">Meneow</h5>
              ...
              <div className="grid md:grid-cols-2">
                <div className="text-start md:ms-8 relative md:order-2">
                  <img
                    ...
                    alt=""
                  />
                  <h5 className="my-2 font-semibold text-lg">Digikala Next</h5>
                  <h6 className="text-sm mb-0">2018-19</h6>
                </div>
